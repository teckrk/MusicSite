...
import "./customAudioPlayerCss.css";
            ...
            >
                ...
                <div className="h-full flex items-center justify-center flex-col gap-3">
                    <motion.i whileTap={{ scale: 0.8 }} onClick={closeMusicPlayer}>
                        <IoMdClose className="text-black hover:text-headingColor text-2xl cursor-pointer" />
                    </motion.i>
                    <motion.i whileTap={{ scale: 0.8 }} onClick={togglePlayer}>
                        <IoArrowRedo className="text-black hover:text-headingColor text-2xl cursor-pointer" />
                    </motion.i>
                </div>
            </div>
            ...
            {miniPlayer && (
                ...
                >
                    <div className="w-40 h-40 rounded-full flex items-center justify-center  relative ">
                        <div className="absolute inset-0 rounded-full bg-yellow-600 blur-xl animate-pulse"></div>
                        <img
...
export const PlayListCard = () => {
    ...
    return (
        <div className="absolute left-4 bottom-24 gap-2 py-2 w-350 max-w-[350px] h-510 max-h-[510px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-second">
            {allSongs.length > 0 ? (
