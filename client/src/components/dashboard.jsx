...
import { DashboardAlbums, DashboardArtists, DashboardHome, DashboardSongs, DashboardUsers } from "."; 
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center justify-center bg-second">
            ...
            <div className="w-[60%] my-2 p-4 flex items-center justify-evenly">
                ...
                <NavLink to={"/dashboard/home"}><IoHome className="text-2xl text-main" /></NavLink>
