...
export const ArtistCard = ({ data, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4">
                <a href={data.instagram} target="_blank">
                    <motion.i whileTap={{ scale: 0.75 }}>
                        <IoLogoInstagram className="text-red-500 hover:text-headingColor text-xl" />
                    </motion.i>
                </a>
                <a href={data.twitter} target="_blank">
                    <motion.i whileTap={{ scale: 0.75 }}>
                        <IoLogoTwitter className="text-sky-500 hover:text-headingColor text-xl" />
                    </motion.i>
                </a>
            </div>
            <motion.i
            ...
            >
                <MdDelete className=" text-red-400 hover:text-brown-400 text-xl cursor-pointer" />
            </motion.i>
