...
const DashboardSongs = () => {
  ...
  return (
    <div className="w-full p-4 flex items-center justify-center flex-col">
      <div className="w-full flex justify-center items-center gap-24">
        ...
        <input
          ...
          className={`w-52 px-4 py-2 border ${isFocus ? "border-gray-500 shadow-md" : "border-gray-300"
            } rounded-md bg-transparent outline-none duration-150 transition-all ease-in-out text-base text-main font-semibold`}
          value={songFilter}
      ...
      <div className="relative w-full  my-4 p-4 py-12 border border-white-300 rounded-md">
  ...
  return (
    ...
    >
      {isDeleted && (
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              className="text-sm px-4 py-1 rounded-md text-black hover:shadow-md bg-teal-400"
              onClick={() => deleteObject(data._id)}
            >
              Yes
            </button>
            <button
              className="text-sm px-4 py-1 rounded-md text-black hover:shadow-md bg-gray-400"
      ...
      <p className="text-base text-black font-semibold my-2">
        ...
        <span className="block text-sm text-black-400 my-1">{data.artist}</span>
      </p>
